...
Future<void> checkAuthentication() async {
  ...
  print('Entities: ${entities != null && entities.isNotEmpty ? 'Present' : 'Not found'}');
  isAuthenticated = entities != null && entities.isNotEmpty;
  isEntitySelected = jwtToken != null && jwtToken.isNotEmpty;
  print('isAuthenticated: $isAuthenticated, isEntitySelected: $isEntitySelected');
}
  ...
  routes: <RouteBase>[
    GoRoute(
      ...
      redirect: (context, state) async {
        ...
        print("After checkAuth - isAuthenticated: $isAuthenticated, isEntitySelected: $isEntitySelected");
        if (isAuthenticated && isEntitySelected) {
          ...
          if (storedPath != null && storedPath != authRoute) {
            print("Auth: User authenticated, will redirect to stored path: $storedPath");
