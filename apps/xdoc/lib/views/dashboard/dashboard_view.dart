...
class _DashboardViewState extends State<DashboardView> {
  ...
  Future<void> fetchChannels() async {
    try {
      ...
      _channelsSubscription = dashboardController
          .fetchChannelsStream(context)
          .listen(
            (data) {
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (!isJoinNew) ...[
                          Text(
                            'You already have similar channels:',
                            style: TextStyle(
                              color: subtitleColor,
                              fontSize: 15,
                            ),
                          ...
                          Wrap(
                            spacing: 10,
                            runSpacing: 10,
                            children: List.generate(channelsList.length, (
                              index,
                            ) {
                    ...
                    ElevatedButton(
                      ...
                      onPressed: selectedExistingChannelIdx != null
                          ? () async {
                              ...
                              final existsinlocal = channels.any(
                                (channel) => channel['channelname'] == newSecQr,
                              );
                              if (existsinlocal) {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (isJoinNew) ...[
                          ...
                          const SizedBox(height: 16),
                          Text(
                            'You can only join a new channel at this time.',
                            style: TextStyle(color: subtitleColor),
                          ),
                        ],
                      ],
    ...
    try {
      ...
      if (!result.success) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text('Channel joining failed')));
        return false;
      }
      ...
      if (mounted) {
        setState(() {
          ...
          final index = channels.indexWhere(
            (c) => c['channelname'] == newChannelName,
          );
                  ...
                  children: [
                    ...
                    if (publicInterconnects.isNotEmpty) ...[
                      ...
                      Wrap(
                        spacing: 10,
                        runSpacing: 10,
                        children: publicInterconnects.map<Widget>((
                          interconnect,
                        ) {
                          return ChoiceChip(
                            label: Text(
                        ...
                        onTap: () async {
                          ...
                          if (picked != null) {
                            ...
                            if (time != null) {
                              ...
                              expireAtController.text = combined
                                  .toUtc()
                                  .toIso8601String();
                            }
                          }
  ...
  void _handleAction(String action, String fileName, String html) {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text(action, style: TextStyle(color: textColor)),
          backgroundColor: surfaceColor,
          content: SizedBox(
            width: 400,
            height: 100,
        ...
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            child: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                Text(qrData, style: TextStyle(color: textColor)),
                const SizedBox(height: 20),
                SizedBox(
                  width: 300,
                  height: 300,
  ...
  Future<void> _showComposeDialog(
    ...
    await showDialog(
      ...
      builder: (BuildContext context) {
        return StatefulBuilder(
          builder: (BuildContext context, StateSetter setState) {
            Future<void> fetchChannelTags(
              int channelIdx, {
              String? autoSelectTagId,
            }) async {
              setState(() {
                pubTags = [];
            ...
            Future<void> searchPubChannels({
              ...
              try {
                final result = await dashboardController.getPubChannels(
                  entity,
                  actorId,
                );
                ...
                setState(() {
                  ...
                  hasSearched = true;
                  selectedTagIndexLocal = null;
                  selectedChannelIndexLocal = (foundChannels.length == 1)
                      ? 0
                      : null;
                });
                ...
                if (triggeredByAuto && secQr != null && secQr!.isNotEmpty) {
                  try {
                    ...
                    final pubIdx = foundChannels.indexWhere(
                      (c) =>
                    ...
                    if (pubIdx != -1) {
                      ...
                      final localIdx = channels.indexWhere(
                        (c) => ((c['channelname'] ?? '').toString()) == target,
                      );
                      if (localIdx != -1) {
                        if (mounted) {
                          setState(() {
                  ...
                  if (foundChannels.length == 1) {
                    final autoChannelName =
                        foundChannels[0]['channelname'] ??
            ...
            final dialogWidth = isMobile
                ? screenWidth * 0.95
                : (screenWidth > 1400 ? 780.0 : screenWidth * 0.56).clamp(
                    600.0,
                    780.0,
                  );
            ...
            final previewTop = isMobile
                ? screenHeight +
                      40 // Below viewport - need to scroll to see
                : 50.0; // Same top position as Create New Document on desktop
            final previewRight = isMobile
                ? null
                : 20.0; // Match the right margin
            final previewLeft = isMobile
                ? (screenWidth - dialogWidth) /
                      2 // Centered on mobile
                : (screenWidth -
                      dialogWidth -
                                      ...
                                      : Column(
                                          ...
                                          children: [
                                            ...
                                            Wrap(
                                              spacing: 10,
                                              runSpacing: 10,
                                              children: pubChannels.asMap().entries.map((
                                                entry,
                                              ) {
                                                final idx = entry.key;
                                ...
                                if (hasSearched &&
                                      ...
                                      children: [
                                        ...
                                        ElevatedButton.icon(
                                          onPressed: () async {
                                            ...
                                            final entityName = _entityController
                                                .text
                                                .trim();
                                            final channelName =
                                                selectedChannelIndexLocal !=
                                                    null
                                                ? pubChannels[selectedChannelIndexLocal!]['channelname'] ??
                                                      'Unknown Channel'
                                                : 'Unknown Channel';
                                  ...
                                  if (pubTags.isNotEmpty)
                                    Wrap(
                                      spacing: 10,
                                      runSpacing: 10,
                                      children: pubTags.asMap().entries.map((
                                        entry,
                                      ) {
                                        final idx = entry.key;
                                  ...
                                  child: InAppWebView(
                                    ...
                                    onWebViewCreated: (controller) async {
                                      ...
                                      if (updatedJson.isNotEmpty &&
                                          updatedJson != "{}") {
                                        try {
                                          final rendered = await renderResume(
                                            updatedJson,
                                          );
  ...
  void _deleteChannel(int index) async {
    final channelName = channels[index]["channelname"];
    final channelId =
        channels[index]["channelid"]?.toString() ??
  ...
  void getDocumentDetails(docId, index) async {
    ...
    if (docDetails != null) {
      ...
      if (stateTransitions != null &&
        ...
        currentExpectedTransitions = stateTransitions
  ...
  Widget buildDocsListOrTagsList() {
    ...
    final List<Map<String, dynamic>> docsList = List<Map<String, dynamic>>.from(
      docs,
    );
                ...
                PopupMenuItem<String>(
                  ...
                  child: Row(
                    children: [
                      ...
                      const SizedBox(width: 12),
                      Text('Channel Tags', style: TextStyle(color: textColor)),
                    ],
                  ),
                ),
                PopupMenuItem<String>(
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                try {
                  ...
                  final encryptedKeys = await _encryptKeys(
                    publicKey,
                    privateKey,
                    password,
                  );
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                try {
                  // Decrypt both keys
                  final decryptedKeys = await _decryptKeys(
                    encryptedKey,
                    password,
                  );

                  // Save the keys
                  final entityName = await dashboardController
                      .getSelectedEntity();
  ...
  Future<Map<String, String>> _decryptKeys(
    ...
    try {
      ...
      return {'publicKey': keyParts[0], 'privateKey': keyParts[1]};
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(title: "dashboard.dashboard", context: context),
      body: Column(
        children: [
      ...
      children: [
        Row(
          children: [
            ...
            if (!isMobile) Container(width: 1, color: borderColor),
