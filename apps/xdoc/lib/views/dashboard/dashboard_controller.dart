...
import '../../core/sqlite/sync_service.dart';
...
''';
  ...
  void logSuccess(String message) {
    ...
    temporaryLogs["success"]!.add({"time": timestamp, "message": message});
  ...
  void logFailure(String message) {
    ...
    temporaryLogs["fail"]!.add({"time": timestamp, "message": message});
  ...
  Future<bool> onboardEntity() async {
    ...
    try {
      final onboardData = {"entityRole": "all"};
      ...
      logFailure(
        "Dio error onboarding entity: ${e.message} - Response: ${e.response?.data}",
      );
      return false;
    } catch (e) {
  ...
  Future<List<dynamic>> getPubChannels(String entity, int actorId) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        logFailure(
          "Failed to fetch pub channels for entity '$entity' - Status: ${response.statusCode}",
        );
      }
    } on DioException catch (e) {
      ...
      print("Response: ${e.response?.data}");
      logFailure(
        "Dio error fetching pub channels for entity '$entity': ${e.message} - Response: ${e.response?.data}",
      );
    } catch (e) {
  ...
  Future<List<dynamic>> getPubChannelTags(
    String entity,
    String channelName,
  ) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        logSuccess(
          "Pub channel tags fetched successfully for entity '$entity', channel '$channelName'",
        );
        return response.data; // assuming API returns a JSON array
      } else {
        print(
          "Failed to fetch channel tags. Status code: ${response.statusCode}",
        );
        logFailure(
          "Failed to fetch pub channel tags for entity '$entity', channel '$channelName' - Status: ${response.statusCode}",
        );
      }
    } on DioException catch (e) {
      ...
      print("Response: ${e.response?.data}");
      logFailure(
        "Dio error fetching pub channel tags for entity '$entity', channel '$channelName': ${e.message} - Response: ${e.response?.data}",
      );
    } catch (e) {
      print("Error fetching channel tags: $e");
      logFailure(
        "Error fetching pub channel tags for entity '$entity', channel '$channelName': $e",
      );
    }
    return [];
  }
  ...
  Future<void> loadData(
    ...
    BuildContext?
    context, // optional context to allow logout on critical errors
  }) async {
    try {
      // Use the new SyncService with MTDS SDK
      await SyncService.loadData(tableNames: [tableName]);
      logSuccess("Data loaded for table: $tableName");
    } catch (e) {
      print("Error fetching $tableName: $e");
      logFailure("Error fetching $tableName: $e");

      // If this is a database error stating a missing table, force logout
      try {
        final msg = e.toString().toLowerCase();
        if ((msg.contains('no such table') || msg.contains('sqlite_error')) &&
            context != null) {
  ...
  Stream<List<Map<String, dynamic>>> fetchChannelsStream(
    BuildContext context,
  ) async* {
    // Load initial data from server (non-blocking)
    loadData("channels", context: context);
    loadData("x_docs");
    loadData("channel_tags");
    loadData("x_doc_actors");
  ...
  Future<List<dynamic>> getRespondentActors(String interconnectId) async {
    ...
    try {
      ...
      print("apiUrl: $apiUrl");
      final response = await dio.get(
        '$apiUrl/respondent-actors/$interconnectId',
      );
      print('Respondent actors response: ${response.data}');
      actors = response.data;
      logSuccess(
        "Respondent actors fetched successfully for interconnect '$interconnectId'",
      );
    } catch (e) {
      print('Error fetching respondent actors: $e');
      logFailure(
        "Error fetching respondent actors for interconnect '$interconnectId': $e",
      );
    }
    return actors;
  }
  ...
  Future<bool> createChannel(String channelName, String actorId) async {
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        logFailure(
          "Failed to create channel '$channelName' - Status: ${response.statusCode}",
        );
      }
    } on DioException catch (e) {
      ...
      print("Response: ${e.response?.data}");
      logFailure(
        "Dio error creating channel '$channelName': ${e.message} - Response: ${e.response?.data}",
      );
    } catch (e) {
  ...
  Future<bool> deleteChannel(String channelId) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        try {
          final sqliteDeleted = await DashboardReplication.deleteChannel(
            channelId,
          );
          if (sqliteDeleted) {
            print("Channel also deleted from SQLite successfully");
            logSuccess(
              "Channel '$channelId' deleted successfully from both API and SQLite",
            );
          } else {
            print("Warning: Channel deleted from API but not found in SQLite");
            logSuccess(
              "Channel '$channelId' deleted successfully from API (not found in SQLite)",
            );
          }
        } catch (e) {
          print("Error deleting channel from SQLite: $e");
          logFailure(
            "Channel '$channelId' deleted from API but failed to delete from SQLite: $e",
          );
        }
        ...
        logFailure(
          "Failed to delete channel '$channelId' - Status: ${response.statusCode}",
        );
      }
    } on DioException catch (e) {
      ...
      print("Response: ${e.response?.data}");
      logFailure(
        "Dio error deleting channel '$channelId': ${e.message} - Response: ${e.response?.data}",
      );
    } catch (e) {
  ...
  Future<JoinChannelResult> joinChannel(
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        logSuccess(
          "Joined channel '$channelName' successfully - New channel name: ${returnedNewChannelName ?? newSecQr}",
        );
        ...
        logFailure(
          "Failed to join channel '$channelName' - Status: ${response.statusCode}",
        );
      ...
      print("Response: ${e.response?.data}");
      logFailure(
        "Dio error joining channel '$channelName': ${e.message} - Response: ${e.response?.data}",
      );
      return JoinChannelResult(success: false);
    } catch (e) {
  ...
  Future<bool> createTag(
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        logFailure(
          "Failed to create tag '$tag' in channel '$channelName' - Status: ${response.statusCode}",
        );
      }
    } on DioException catch (e) {
      ...
      print("Response: ${e.response?.data}");
      logFailure(
        "Dio error creating tag '$tag': ${e.message} - Response: ${e.response?.data}",
      );
    } catch (e) {
  ...
  Future<List<dynamic>> getDocs(String channelName) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        logFailure(
          "Failed to fetch docs for channel '$channelName' - Status: ${response.statusCode}",
        );
      }
    } on DioException catch (e) {
      ...
      print("Response: ${e.response?.data}");
      logFailure(
        "Dio error fetching docs for channel '$channelName': ${e.message} - Response: ${e.response?.data}",
      );
    } catch (e) {
  ...
  Future<Map<String, dynamic>?> getContextAndPublicKey(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        logSuccess(
          "Context and public key fetched successfully for entity '$entityName', channel '$channelName'$tagInfo",
        );
        ...
        final tagInfo = tagId != null ? ", tag '$tagId'" : " (no tag)";
        logFailure(
          "Failed to fetch context and public key for entity '$entityName', channel '$channelName'$tagInfo - Status: ${response.statusCode}",
        );
      }
    } on DioException catch (e) {
      ...
      print("Response: ${e.response?.data}");
      logFailure(
        "Dio error fetching context and public key for entity '$entityName': ${e.message} - Response: ${e.response?.data}",
      );
      return e.response?.data;
    } catch (e) {
      print("Error fetching context and public key: $e");
      logFailure(
        "Error fetching context and public key for entity '$entityName': $e",
      );
    }
    return null;
  }
  ...
  Future<Map<String, dynamic>?> getDocumentDetails(String docId) async {
    ...
    try {
      ...
      final keyBuf =
          details["current_user_encryptedsymmetrickey"]
      ...
      logSuccess(
        "Document details fetched and decrypted successfully for document '$docId'",
      );
      return {
        "data": data,
      ...
      print("Response: ${e.response?.data}");
      logFailure(
        "Dio error fetching document details for document '$docId': ${e.message} - Response: ${e.response?.data}",
      );
      return e.response?.data;
    } catch (e) {
  ...
  Future<bool> uploadPublicKey(String publicKey, String privateKey) async {
    String token = await getJwt();
    try {
      final data = {"publicKey": publicKey};
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        logSuccess(
          "Public key uploaded successfully for entity '$parentEntity'",
        );
        return true;
      } else {
        logFailure(
          "Failed to upload public key - Status: ${response.statusCode}",
        );
      }
    } on DioException catch (e) {
      ...
      print("Response: ${e.response?.data}");
      logFailure(
        "Dio error uploading public key: ${e.message} - Response: ${e.response?.data}",
      );
    } catch (e) {
  ...
  Future<Map<String, dynamic>?> getEntityPublicKey(String entityName) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        logSuccess(
          "Entity public key retrieved successfully for entity '$entityName'",
        );
        return response.data;
      } else if (response.statusCode == 404) {
        print("Entity not found for entity: $entityName");
        logFailure(
          "Entity not found when retrieving public key for entity '$entityName' - Status: ${response.statusCode}",
        );
        return null;
      } else if (response.statusCode == 422) {
        print("Invalid request: entity name is required");
        logFailure(
          "Invalid request when retrieving public key - entity name is required - Status: ${response.statusCode}",
        );
        return null;
      } else {
        print(
          "Failed to retrieve entity public key. Status code: ${response.statusCode}",
        );
        logFailure(
          "Failed to retrieve entity public key for entity '$entityName' - Status: ${response.statusCode}",
        );
      }
    } on DioException catch (e) {
      ...
      print("Response: ${e.response?.data}");
      logFailure(
        "Dio error retrieving entity public key for entity '$entityName': ${e.message} - Response: ${e.response?.data}",
      );
      return e.response?.data;
    } catch (e) {
      print("Error retrieving entity public key: $e");
      logFailure(
        "Error retrieving entity public key for entity '$entityName': $e",
      );
    }
    return null;
  }
  ...
  Future<void> addOrUpdateEntityKeys(
    ...
    keysMap[parentEntity] = {"publicKey": publicKey, "privateKey": privateKey};
  ...
  Future<bool> createEncryptedDocument({
    ...
    if (submittedData.isEmpty) {
      ...
      logFailure(
        "Submitted data is empty when creating encrypted document - entity: '$entityName', channel: '$channelName'",
      );
      return false;
    }
    ...
    try {
      ...
      try {
        ...
        if (symmetrickey == null) {
          ...
          logFailure(
            "Failed to generate symmetric key for entity '$entityName', channel '$channelName'",
          );
          return false;
        }
      } catch (e) {
        ...
        logFailure(
          "Error generating symmetric key for entity '$entityName', channel '$channelName': $e",
        );
        return false;
      }
      ...
      try {
        ...
        logFailure(
          "Failed to encrypt context data for entity '$entityName', channel '$channelName': $e",
        );
        return false;
      }
      ...
      if (senderKeys == null) {
        print("❌ Sender keys not found.");
        logFailure(
          "Sender keys not found for creating encrypted document - entity: '$entityName', channel: '$channelName'",
        );
        return false;
      }
      ...
      if (recipientResponse == null || recipientResponse['publicKey'] == null) {
        ...
        logFailure(
          "Recipient keys not found for entity '$entityName' when creating encrypted document - channel: '$channelName'",
        );
        return false;
      }
      ...
      try {
        primaryEntitySymmetricKey = await rsaEncryption(
        ...
        logFailure(
          "Failed to encrypt symmetric key with sender public key for entity '$entityName', channel '$channelName': $e",
        );
        return false;
      }

      try {
        otherActorSymmetricKey = await rsaEncryption(
          symmetrickey.toString(),
          recipientPublicPem,
        );
      } catch (e) {
        print(
          "❌ Failed to encrypt symmetric key with recipient public key: $e",
        );
        logFailure(
          "Failed to encrypt symmetric key with recipient public key for entity '$entityName', channel '$channelName': $e",
        );
        return false;
      }
      ...
      try {
        ...
        if (token.isEmpty) {
          ...
          logFailure(
            "JWT token is empty when creating encrypted document - entity: '$entityName', channel: '$channelName'",
          );
          return false;
        }
      } catch (e) {
        ...
        logFailure(
          "Error getting JWT token when creating encrypted document - entity: '$entityName', channel: '$channelName': $e",
        );
        return false;
      }
      ...
      try {
        ...
        logFailure(
          "Failed to encode request body to JSON for entity '$entityName', channel '$channelName': $e",
        );
        return false;
      }
      ...
      if (apiUrl.isEmpty) {
        ...
        logFailure(
          "API URL is empty when creating encrypted document for entity '$entityName', channel '$channelName'",
        );
        return false;
      }
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        logSuccess(
          "Encrypted document created successfully for entity '$entityName' in channel '$channelName'",
        );
        return true;
      } else {
        ...
        logFailure(
          "Failed to create encrypted document for entity '$entityName' - Status: ${response.statusCode} - Error: ${response.data}",
        );
        return false;
      }
    } on DioException catch (e) {
      ...
      print("Response: ${e.response?.data}");
      logFailure(
        "Dio error creating encrypted document for entity '$entityName': ${e.message} - Response: ${e.response?.data}",
      );
      return false;
    } catch (e) {
      print("Error creating document: $e");
      logFailure(
        "Error creating encrypted document for entity '$entityName': $e",
      );
      return false;
    }
  }
  ...
  Future<bool> updateEncryptedEvent({
    ...
    try {
      ...
      final decryptedBase64 = await rsaDecryption(
        encryptedKeyBase64,
        privateKeyPem,
      );
      ...
      if (updateResponse.statusCode == 200 ||
        ...
        logSuccess(
          "Document '$docid' updated successfully with action '$actionName'",
        );
        return true;
      } else {
        ...
        logFailure(
          "Failed to update document '$docid' with action '$actionName' - Status: ${updateResponse.statusCode}",
        );
        return false;
      }
    } on DioException catch (e) {
      ...
      print("Response: ${e.response?.data}");
      logFailure(
        "Dio error updating document '$docid' with action '$actionName': ${e.message} - Response: ${e.response?.data}",
      );
      return false;
    } catch (e) {
      print("Error creating document: $e");
      logFailure(
        "Error updating document '$docid' with action '$actionName': $e",
      );
      return false;
    }
  }
  ...
  Future<dynamic> getChannelDetailsForJoin({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        logSuccess(
          "Channel details fetched successfully for entity '$entityId', channel '$channelName', tag '$tagId'",
        );
        ...
        logFailure(
          "Failed to fetch channel details for entity '$entityId', channel '$channelName', tag '$tagId' - Status: ${response.statusCode}",
        );
      }
    } on DioException catch (e) {
      ...
      print("Response: ${e.response?.data}");
      logFailure(
        "Dio error fetching channel details for entity '$entityId', channel '$channelName': ${e.message} - Response: ${e.response?.data}",
      );
    } catch (e) {
      print("Error fetching channel details: $e");
      logFailure(
        "Error fetching channel details for entity '$entityId', channel '$channelName': $e",
      );
    }
    return null;
  }
  ...
  Future<dynamic> getReciprocalChannelDetails({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        print(
          "Reciprocal channel details fetched successfully: ${response.data}",
        );
        logSuccess(
          "Reciprocal channel details fetched successfully for otherUserTid '$otherUserTid', channel '$otherChannelName'",
        );
        logSuccess(
          'Reciprocal channel details fetched successfully: ${response.data}',
        );
        ...
        print(
          "No reciprocal channel details found. Status code: ${response.statusCode}",
        );
        logFailure(
          "No reciprocal channel details found for otherUserTid '$otherUserTid', channel '$otherChannelName' - Status: ${response.statusCode}",
        );
        return response.data;
      } else {
        print(
          "Failed to fetch reciprocal channel details. Status code: ${response.statusCode}",
        );
        logFailure(
          "Failed to fetch reciprocal channel details for otherUserTid '$otherUserTid', channel '$otherChannelName' - Status: ${response.statusCode}",
        );
      }
    } on DioException catch (e) {
      ...
      print("Response: ${e.response?.data}");
      logFailure(
        "Dio error fetching reciprocal channel details for otherUserTid '$otherUserTid', channel '$otherChannelName': ${e.message} - Response: ${e.response?.data}",
      );
      return e.response?.data;
    } catch (e) {
      print("Error fetching reciprocal channel details: $e");
      logFailure(
        "Error fetching reciprocal channel details for otherUserTid '$otherUserTid', channel '$otherChannelName': $e",
      );
    }
    return null;
  }
