...
class ActorsView extends StatelessWidget {
  ...
  const ActorsView({Key? key, required this.title, required this.actors})
    : super(key: key);
          ...
          Expanded(
            child: Padding(
              ...
              child: GridView.count(
                ...
                children: actors
                    .map(
                      (actor) => _buildSquareBox(actor, context),
                    ) // pass context
                    .toList(),
              ),
            ),
  ...
  Widget _buildHeroSection() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Center(child: Icon(Icons.group, size: 60, color: Colors.grey[300])),
          SizedBox(height: 12),
          Text(
            'Actors for $title',
            style: TextStyle(
  ...
  Widget _buildSquareBox(Map<String, dynamic> actor, BuildContext context) {
    // add context param
    return Container(
      decoration: BoxDecoration(
      ...
      child: InkWell(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Icon(actor['icon'], size: 32, color: Colors.white),
              SizedBox(height: 6),
              Text(
                actor['title'],
                style: TextStyle(
